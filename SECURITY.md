...
- This software relies on your browser session for access to ChatGPT. Do not run this on an environment you do not control.
...
- Requests proxied through this software will be processed by the ChatGPT web UI under your account — be aware of rate limits and ToS implications.
